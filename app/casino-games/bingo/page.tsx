...
export default function Bingo() {
  return (
    <div>
      ...
      {/* Breadcrumb */}
      <div className="container mx-auto mt-2 px-4 py-2 bg-[#F9FAFB] border-b border-gray-200 mb-4">
      ...
      <div className="container mx-auto px-6 py-4 ">
        <div className="bg-gradient-to-r from-[#e91e63] to-[#ad1457] rounded-3xl px-12 py-8 text-center text-white mb-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12 span-9">
        ...
        <div className="lg:col-span-9">
          ...
          <div className="bg-white rounded-lg p-8 ">
            ...
            <h2 className="text-2xl font-bold mb-4 mt-6" id="the-legal-situation">
              The legal situation in the Norwegian casino sector</h2>
            <p className="text-gray-700 mb-6">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg p-8 sticky top-8">
            ...
            <nav className="space-y-3">
              ...
              >
                <FileText className="w-6 h-6 mr-2 text-[#E71E62]" />
                <span className="text-sm">How do we rate the best New Zealand casinos for our list?</span>
              </Link>
              <Link
                href="#the-legal-situation"
                className="flex items-center text-gray-700 hover:text-[#e91e63] transition-colors"
              >
                <FileText className="w-6 h-6 mr-2 text-[#E71E62]" />
                <span className="text-sm">The legal situation in the Norwegian casino sector</span>
              </Link>
              <Link href="#online-casino" className="flex items-center text-gray-700 hover:text-[#e91e63] transition-colors">
                <FileText className="w-4 h-4 mr-2 text-[#E71E62]" />
                <span className="text-sm"> Online casino in Norway and responsible gambling</span>
              </Link>
              <Link
                href="#faqs"
                className="flex items-center text-gray-700 hover:text-[#e91e63] transition-colors"
